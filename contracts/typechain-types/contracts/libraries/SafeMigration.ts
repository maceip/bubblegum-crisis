...
export interface SafeMigrationInterface extends utils.Interface {
  functions: {
    ...
    "zodiacMechMastercopy()": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "zodiacMechMastercopy",
    values?: undefined
  ): string;
...
export interface SafeMigration extends BaseContract {
  ...
  functions: {
    ...
    zodiacMechMastercopy(overrides?: CallOverrides): Promise<[string]>;
  };
  ...
  estimateGas: {
    ...
    zodiacMechMastercopy(overrides?: CallOverrides): Promise<BigNumber>;
  };
