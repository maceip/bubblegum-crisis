...
export interface ImmutableStorageTestInterface extends utils.Interface {
  functions: {
...
export interface ImmutableStorageTest extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ImmutableStorageTestInterface;
  ...
  functions: {
    read(overrides?: CallOverrides): Promise<[string] & { data: string }>;
